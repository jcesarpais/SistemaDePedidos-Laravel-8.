		...
		<div class="container">
			<div class="add-products-row">
				<div class="w3ls-add-grids">
					<a href="{{ asset('/') }}FrontEndSourceFile/menu.html"> 
			...
			<div class="spldishes-agileinfo">
				...
				<div class="col-md-9 spldishes-grids">
					...
					<div id="owl-demo" class="owl-carousel text-center agileinfo-gallery-row">
                        ...
                        @foreach ($prato as $pratos)
                            <a href="{{ route('categoria_pratos', ['category_id'=>$pratos->category_id]) }}" class="item g1">
                                <img class="lazyOwl" src="{{ $pratos->pratos_image }}" style="whidth:300px; height:190px" title="Our latest gallery" alt=""/>
